<!-- Docsify _sidebar.md template for k-ai docs -->
<!-- Keep this file at repo root when publishing with GitHub Pages -->
<!-- IMPORTANT: also create .nojekyll or GitHub Pages will drop _sidebar.md -->
